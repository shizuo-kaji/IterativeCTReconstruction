...
optim = {
    ...
    'AdaBound': functools.partial(optimizers.Adam, amsgrad=True, adabound=True),
    'Adam_d': functools.partial(optimizers.Adam, beta1=0.1),
    'AdaBound_d': functools.partial(optimizers.Adam, beta1=0.1, adabound=True),
